    ...
    <footer>
      <div className="container">
        <div className="navigation__wrapper row">
          ...
          <div className="navigation__sitemap col-8 justify-content-around">
        ...
        <div className="data__wrapper row justify-content-between">
        ...
        <div className="developers justify-content-between">
